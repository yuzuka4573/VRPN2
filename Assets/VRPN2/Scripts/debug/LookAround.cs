...
using Live2D.Cubism.Framework.Physics;
    ...
    public sealed class LookAround : MonoBehaviour
    {
        ...
        {
            "PARAM_ANGLE_X",		// -30 to 30
			"PARAM_ANGLE_Y",		// -30 to 30
			"PARAM_ANGLE_Z",		// -30 to 30
			"PARAM_BODY_ANGLE_X",	// -10 to 10
			"PARAM_BODY_ANGLE_Z",	// -10 to 10
			"PARAM_EYE_BALL_X",	// -1  to 1
			"PARAM_EYE_BALL_Y",	// -1  to 1
		};
